...
public class PostUpdateNotificationTest extends ContainerBaseTest {
    ...
    void authorAccountNotNotified() throws Exception{
        ...
        String tagOfNewPost = "tag 1.,tag 11.,tag 111.,tag 2.,tag 3.";
        ...
        this.webNotificationVerification(TEST_USER_ID, new ArrayList<>());
    }
    ...
    void emailAndWebNotificationWhenNotificationSettingIsTrue() throws Exception{
        ...
        accountTestUserId1.setNotificationMyInterestTagAddedToExistingPostByEmail(false);
        accountTestUserId2.setNotificationMyInterestTagAddedToExistingPostByWeb(false);
